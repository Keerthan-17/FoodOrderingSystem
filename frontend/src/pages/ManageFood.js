    ...
    <AdminLayout>
      <div>
        <h3 className="text-center text-primary mb-4">
          <i className="fas fa-list me-1"></i> Manage Food Item
        </h3>

        <h5 className='text-end text-muted'>
          <i className='fas fa-database'></i> Total Food Items
          <span className='ms-2 me-2 badge bg-success'>{foods.length}</span>
        </h5>

        <div className='mb-4 d-flex justify-content-between'>
          <input type='text' className='form-control w-50' placeholder='Search By Food Item Name...'
          onChange={(e)=>handleSearch(e.target.value)}></input>

          <CSVLink data={foods} className='btn btn-success' filename={'food_item.csv'}>
